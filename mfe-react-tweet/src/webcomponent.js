...
import './index.css';
import MfeReactTweet from './MfeReactTweet';

class MfeReactTweetCustomElement extends HTMLElement {
  ...
  mount() {
    const propTypes = MfeReactTweet.propTypes ? MfeReactTweet.propTypes : {};
    const events = MfeReactTweet.propTypes ? MfeReactTweet.propTypes : {};
    const props = {
      ...this.getProps(this.attributes, propTypes),
      ...this.getEvents(events),
      children: this.parseHtmlToReact(this.innerHTML)
    };
    render(<MfeReactTweet {...props} />, this);
  }
...
customElements.define('mfe-react-tweet', MfeReactTweetCustomElement);